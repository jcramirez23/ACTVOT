...
namespace ACTVOT.Web.Controllers
{
    public class ActVotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Actstar,Endstar,ImageUrl")] ActVote actVote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Actstar,Endstar,ImageUrl")] ActVote actVote)
        {
            if (id != actVote.Id)
            {
                return NotFound();
